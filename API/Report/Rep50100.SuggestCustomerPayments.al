...
// report 50100 "Suggest Customer Payments"
// {
...
//                     CurrReport.Break();
//                 Window.Update(1, "No.");
//                 if IncludeCustomer(Customer, CustomerBalance) then begin
...
//         OnGetCustLedgEntriesOnAfterCustLedgEntrySetFilters(CustLedgEntry, Customer, PostingDate, LastDueDateToPayReq, Positive, Future);

//         if CustLedgEntry.FindSet() then
//             repeat
//                 IsHandled := false;
//                 OnGetCustLedgEntriesOnBeforeLoop(CustLedgEntry, PostingDate, LastDueDateToPayReq, Future, IsHandled);
//                 if not IsHandled then begin
//                     SaveAmount();
//                     if CustLedgEntry."Accepted Pmt. Disc. Tolerance" or (CustLedgEntry."Accepted Payment Tolerance" <> 0) then begin
//                         CustLedgEntry."Accepted Pmt. Disc. Tolerance" := false;
//                         CustLedgEntry."Accepted Payment Tolerance" := 0;
//                         CODEUNIT.Run(CODEUNIT::"Vend. Entry-Edit", CustLedgEntry);
//                     end;
//                 end;
//             until CustLedgEntry.Next() = 0;
//         OnAfterGetCustLedgEntries(CustLedgEntry, Customer, PostingDate, LastDueDateToPayReq, UsePriority, UseDueDateAsPostingDate, DueDateOffset, Positive, Future, TempPayableVendorLedgerEntry, NextEntryNo, SkipExportedPayments);
//     end;
...
//     begin
//         GenJnlLine.Init();
//         SetPostingDate(GenJnlLine, GetVendorLedgerEntryDueDate(CustLedgEntry."Entry No."), PostingDate);
//         GenJnlLine."Document Type" := GenJnlLine."Document Type"::Payment;
//         GenJnlLine."Account Type" := GenJnlLine."Account Type"::Vendor;
//         Cust2.Get(CustLedgEntry."Customer No.");
//         Cust2.CheckBlockedVendOnJnls(Cust2, GenJnlLine."Document Type", false);
//         GenJnlLine.Description := Cust2.Name;
//         GenJnlLine."Salespers./Purch. Code" := Cust2."Purchaser Code";
...
//         if PaymentToleranceMgt.CheckCalcPmtDiscGenJnlVend(GenJnlLine, CustLedgEntry, 0, false) then
//             GenJnlLine.Amount := -(CustLedgEntry."Remaining Amount" - CustLedgEntry.GetRemainingPmtDiscPossible(GenJnlLine."Posting Date"))
//         else
//             GenJnlLine.Amount := -CustLedgEntry."Remaining Amount";
//         GenJnlLine.Validate(Amount);

//         if UsePriority then
//             TempPayableVendorLedgerEntry.Priority := Customer.Priority
//         else
//             TempPayableVendorLedgerEntry.Priority := 0;
//         TempPayableVendorLedgerEntry."Vendor No." := CustLedgEntry."Customer No.";
//         TempPayableVendorLedgerEntry."Entry No." := NextEntryNo;
//         TempPayableVendorLedgerEntry."Vendor Ledg. Entry No." := CustLedgEntry."Entry No.";
...
//         TempPayableVendorLedgerEntry.Future := (CustLedgEntry."Due Date" > LastDueDateToPayReq);
//         TempPayableVendorLedgerEntry."Currency Code" := CustLedgEntry."Currency Code";
//         TempPayableVendorLedgerEntry.Insert();
//         NextEntryNo := NextEntryNo + 1;
//         OnAfterSaveAmount(GenJnlLine, TempPayableVendorLedgerEntry, CustLedgEntry);
//     end;
...
//     begin
//         IsHandled := false;
//         OnBeforeCheckAmounts(TempPayableVendorLedgerEntry, OriginalAmtAvailable, AmountAvailable, StopPayments, Future, Customer, IsHandled);
//         if IsHandled then
//             exit;

//         TempPayableVendorLedgerEntry.SetRange("Vendor No.", Customer."No.");
...
//                 repeat
//                     CustLedgEntry.Get(TempPayableVendorLedgerEntry."Vendor Ledg. Entry No.");
//                     SetPostingDate(GenJnlLine1, GetVendorLedgerEntryDueDate(CustLedgEntry."Entry No."), PostingDate);
//                     HandledEntry := CustLedgEntry."Posting Date" <= GenJnlLine1."Posting Date";
//                     OnBeforeHandledCustLedgEntry(CustLedgEntry, GenJnlLine1, HandledEntry);
//                     if HandledEntry then begin
//                         TempVendorPaymentBuffer."Vendor No." := CustLedgEntry."Customer No.";
//                         TempVendorPaymentBuffer."Currency Code" := CustLedgEntry."Currency Code";
//                         TempVendorPaymentBuffer."Payment Method Code" := CustLedgEntry."Payment Method Code";

//                         TempVendorPaymentBuffer.CopyFieldsFromVendorLedgerEntry(CustLedgEntry);
//                         OnUpdateVendorPaymentBufferFromVendorLedgerEntry(TempVendorPaymentBuffer, CustLedgEntry);
// #if not CLEAN22
//                         TempPaymentBuffer.CopyFieldsFromVendorPaymentBuffer(TempVendorPaymentBuffer);
//                         OnUpdateTempBufferFromVendorLedgerEntry(TempPaymentBuffer, CustLedgEntry);
...
//                         if IsNotAppliedEntry(GenJnlLine, CustLedgEntry) then begin
//                             OnMakeGenJnlLinesOnBeforeUpdateVendorPaymentBufferAmounts(TempVendorPaymentBuffer, CustLedgEntry, SummarizePerVend);
// #if not CLEAN22
//                             TempPaymentBuffer.CopyFieldsFromVendorPaymentBuffer(TempVendorPaymentBuffer);
//                             OnMakeGenJnlLinesOnBeforeUpdateTempPaymentBufferAmounts(TempPaymentBuffer, CustLedgEntry, SummarizePerVend);
//                             TempVendorPaymentBuffer.CopyFieldsFromPaymentBuffer(TempPaymentBuffer);
// #endif
...
//                                     OnMakeGenJnlLinesOnBeforeVendorPaymentBufferModify(TempVendorPaymentBuffer, CustLedgEntry);
// #if not CLEAN22
//                                     TempPaymentBuffer.CopyFieldsFromVendorPaymentBuffer(TempVendorPaymentBuffer);
//                                     OnMakeGenJnlLinesOnBeforeTempPaymentBufferModify(TempPaymentBuffer, CustLedgEntry);
//                                     TempVendorPaymentBuffer.CopyFieldsFromPaymentBuffer(TempPaymentBuffer);
// #endif
...
//                                     OnMakeGenJnlLinesOnBeforeVendorPaymentBufferInsert(TempVendorPaymentBuffer, CustLedgEntry, TempPayableVendorLedgerEntry);
// #if not CLEAN22
//                                     TempPaymentBuffer.CopyFieldsFromVendorPaymentBuffer(TempVendorPaymentBuffer);
//                                     OnMakeGenJnlLinesOnBeforeTempPaymentBufferInsert(TempPaymentBuffer, CustLedgEntry, TempPayableVendorLedgerEntry);
//                                     TempVendorPaymentBuffer.CopyFieldsFromPaymentBuffer(TempPaymentBuffer);
// #endif
//                                     TempVendorPaymentBuffer.Insert();
//                                 end;
//                                 CustLedgEntry."Applies-to ID" := TempVendorPaymentBuffer."Document No.";
//                             end else begin
//                                 TempVendorPaymentBuffer."Vendor Ledg. Entry Doc. Type" := CustLedgEntry."Document Type";
//                                 TempVendorPaymentBuffer."Vendor Ledg. Entry Doc. No." := CustLedgEntry."Document No.";
//                                 TempVendorPaymentBuffer."Global Dimension 1 Code" := CustLedgEntry."Global Dimension 1 Code";
//                                 TempVendorPaymentBuffer."Global Dimension 2 Code" := CustLedgEntry."Global Dimension 2 Code";
//                                 TempVendorPaymentBuffer."Dimension Set ID" := CustLedgEntry."Dimension Set ID";
//                                 TempVendorPaymentBuffer."Vendor Ledg. Entry No." := CustLedgEntry."Entry No.";
//                                 TempVendorPaymentBuffer.Amount := TempPayableVendorLedgerEntry.Amount;
//                                 Window2.Update(1, CustLedgEntry."Customer No.");
//                                 OnMakeGenJnlLinesOnBeforeVendorPaymentBufferInsertNonSummarize(TempVendorPaymentBuffer, CustLedgEntry, SummarizePerVend, NextDocNo);
// #if not CLEAN22
//                                 TempPaymentBuffer.CopyFieldsFromVendorPaymentBuffer(TempVendorPaymentBuffer);
//                                 OnMakeGenJnlLinesOnBeforeTempPaymentBufferInsertNonSummarize(TempPaymentBuffer, CustLedgEntry, SummarizePerVend, NextDocNo);
//                                 TempVendorPaymentBuffer.CopyFieldsFromPaymentBuffer(TempPaymentBuffer);
// #endif
//                                 TempVendorPaymentBuffer.Insert();
//                             end;
...
//                         CODEUNIT.Run(CODEUNIT::"Vend. Entry-Edit", CustLedgEntry);
//                     end else begin
//                         TempVendorLedgerEntry := CustLedgEntry;
...
//     begin
//         IsHandled := false;
//         OnBeforeClearNegative(TempPayableVendorLedgerEntry, AmountAvailable, Customer, IsHandled);
//         if IsHandled then
//             exit;
...
//         EntryNo: Integer;
//     begin
//         OnBeforeSetTempPaymentBufferDims(CustLedgEntry, SummarizePerDim);
//         if SummarizePerDim then begin
//             DimBuf.Reset();
//             DimBuf.DeleteAll();
//             if SelectedDim.FindSet() then
//                 repeat
//                     if DimSetEntry.Get(CustLedgEntry."Dimension Set ID", SelectedDim."Dimension Code") then
...
//     local procedure IsNotAppliedEntry(GenJournalLine: Record "Gen. Journal Line"; CustomerLedgerEntry: Record "Cust. Ledger Entry"): Boolean
//     begin
//         exit(
...
//     local procedure IsNotAppliedToCurrentBatchLine(GenJournalLine: Record "Gen. Journal Line"; CustomerLedgerEntry: Record "Cust. Ledger Entry"): Boolean
//     var
...
//         PaymentGenJournalLine.SetRange("Account No.", CustomerLedgerEntry."Customer No.");
//         PaymentGenJournalLine.SetRange("Applies-to Doc. Type", CustomerLedgerEntry."Document Type");
//         PaymentGenJournalLine.SetRange("Applies-to Doc. No.", CustomerLedgerEntry."Document No.");
...
//     [IntegrationEvent(false, false)]
//     local procedure OnAfterSaveAmount(var GenJournalLine: Record "Gen. Journal Line"; var TempPayableVendorLedgerEntry: Record "Payable Vendor Ledger Entry" temporary; CustomerLedgerEntry: Record "Cust. Ledger Entry")
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnUpdateTempBufferFromVendorLedgerEntry(var TempPaymentBuffer: Record "Payment Buffer" temporary; CustomerLedgerEntry: Record "Cust. Ledger Entry")
//     begin
//     end;
// #endif

//     [IntegrationEvent(false, false)]
//     local procedure OnUpdateVendorPaymentBufferFromVendorLedgerEntry(var TempVendorPaymentBuffer: Record "Vendor Payment Buffer" temporary; CustomerLedgerEntry: Record "Cust. Ledger Entry")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeCheckAmounts(var PayableVendorLedgerEntry: Record "Payable Vendor Ledger Entry"; var OriginalAmtAvailable: Decimal; var AmountAvailable: Decimal; var StopPayments: Boolean; Future: Boolean; Customer: Record Customer; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeClearNegative(var TempPayableVendorLedgerEntry: Record "Payable Vendor Ledger Entry" temporary; var AmountAvailable: Decimal; Customer: Record Customer; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeHandledCustLedgEntry(CustomerLedgerEntry: Record "Cust. Ledger Entry"; GenJournalLine: Record "Gen. Journal Line"; var HandledEntry: Boolean)
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeSetTempPaymentBufferDims(CustomerLedgerEntry: Record "Cust. Ledger Entry"; var SummarizePerDim: Boolean)
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnGetCustLedgEntriesOnBeforeLoop(var CustomerLedgerEntry: Record "Cust. Ledger Entry"; PostingDate: Date; LastDueDateToPayReq: Date; Future: Boolean; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnGetCustLedgEntriesOnAfterCustLedgEntrySetFilters(var CustomerLedgerEntry: Record "Cust. Ledger Entry"; Customer: Record Customer; PostingDate: Date; LastDueDateToPayReq: Date; Positive: Boolean; Future: Boolean)
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnMakeGenJnlLinesOnBeforeUpdateTempPaymentBufferAmounts(var TempPaymentBuffer: Record "Payment Buffer" temporary; CustomerLederEntry: Record "Cust. Ledger Entry"; var SummarizePerVend: Boolean)
//     begin
//     end;
// #endif

//     [IntegrationEvent(false, false)]
//     local procedure OnMakeGenJnlLinesOnBeforeUpdateVendorPaymentBufferAmounts(var TempVendorPaymentBuffer: Record "Vendor Payment Buffer" temporary; CustomerLederEntry: Record "Cust. Ledger Entry"; var SummarizePerVend: Boolean)
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnMakeGenJnlLinesOnBeforeTempPaymentBufferInsertNonSummarize(var TempPaymentBuffer: Record "Payment Buffer" temporary; CustomerLederEntry: Record "Cust. Ledger Entry"; var SummarizePerVend: Boolean; var NextDocNo: Code[20])
//     begin
//     end;
// #endif

//     [IntegrationEvent(false, false)]
//     local procedure OnMakeGenJnlLinesOnBeforeVendorPaymentBufferInsertNonSummarize(var TempVendorPaymentBuffer: Record "Vendor Payment Buffer" temporary; CustomerLederEntry: Record "Cust. Ledger Entry"; var SummarizePerVend: Boolean; var NextDocNo: Code[20])
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnMakeGenJnlLinesOnBeforeTempPaymentBufferInsert(var TempPaymentBuffer: Record "Payment Buffer" temporary; CustomerLederEntry: Record "Cust. Ledger Entry"; TempPayableVendorLedgerEntry: Record "Payable Vendor Ledger Entry" temporary)
//     begin
//     end;
// #endif

//     [IntegrationEvent(false, false)]
//     local procedure OnMakeGenJnlLinesOnBeforeVendorPaymentBufferInsert(var TempVendorPaymentBuffer: Record "Vendor Payment Buffer" temporary; CustomerLederEntry: Record "Cust. Ledger Entry"; TempPayableVendorLedgerEntry: Record "Payable Vendor Ledger Entry" temporary)
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnMakeGenJnlLinesOnBeforeTempPaymentBufferModify(var TempPaymentBuffer: Record "Payment Buffer" temporary; CustomerLederEntry: Record "Cust. Ledger Entry")
//     begin
//     end;
// #endif

//     [IntegrationEvent(false, false)]
//     local procedure OnMakeGenJnlLinesOnBeforeVendorPaymentBufferModify(var TempVendorPaymentBuffer: Record "Vendor Payment Buffer" temporary; CustomerLederEntry: Record "Cust. Ledger Entry")
//     begin
//     end;
...
// // det:Record "Detailed Cust. Ledg. Entry";

            ...
            dataitem("Sales Invoice Line"; "Sales Invoice Line")
            {
                ...
                begin
                    if "Sales Invoice Line".Type = Type::Item then begin
                        ...
                        TotalInclVAT:=0;
                        DocumentTotals.CalculatePostedSalesInvoiceTotals("Sales Invoice Header", TotalInclVAT, "Sales Invoice Line");
                    // if "Sales Invoice Line".FindSet() then
                    //     repeat
                    //         TotalInclVAT += "Sales Invoice Line"."Amount Including VAT";

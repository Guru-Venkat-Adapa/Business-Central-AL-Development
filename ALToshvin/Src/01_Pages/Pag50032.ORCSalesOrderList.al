page 50032 "ORC Sales Order List"
{
    ApplicationArea = Basic, Suite, Assembly;
    Caption = 'ORC Sales Orders';
    CardPageID = "ORC Sales Order";
    DataCaptionFields = "Sell-to Customer No.";
    Editable = false;
    PageType = List;
    QueryCategory = 'ORC Sales Order List';
    RefreshOnActivate = true;
    SourceTable = "Sales Header";
    SourceTableView = where("Document Type" = const(Order),
                            "Sales Order Type" = const('INSTRUMENT ORC|SPARES ORC'));
    UsageCategory = Lists;
...
#pragma warning restore
    ...
    begin
        ...
        // Rec.SetRange("Sales Order Type", 'Sales Order for ORC');

        // Filter List as per user location'

page 50034 "ORC Sales Order Subform"
{
    AutoSplitKey = true;
    Caption = 'Lines';
    DelayedInsert = true;
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Item by Toshvin"; Rec."Item by Toshvin")
                {
                    ApplicationArea = All;
                    Caption = 'Main Instrument';
                }
                ...
                field(Quantity; Rec.Quantity)
                {
                    ...
                    begin
                        ...
                        RecalculateCommissionNoteAmount();
                    end;
                }
                ...
                field("Unit Price"; Rec."Unit Price")
                {
                    ...
                    CaptionClass = 'Unit Price Excel. GST';
                ...
                //04/02/26 code related to commission note amount
                ...
                field("Insurance Charge"; Rec."Insurance Charge")
                {
                    ApplicationArea = All;
                    trigger OnValidate()
                    begin
                ...
                field("Negotiated Price"; Rec."Negotiated Price")
                {
                    ApplicationArea = All;
                    trigger OnValidate()
                    begin
                ...
                field("CN Other Charges"; Rec."CN Other Charges")
                {
                    ApplicationArea = All;
                    trigger OnValidate()
                    begin
                ...
                field("Commission Note Amount"; Rec."Commission Note Amount")
                {
                    ApplicationArea = All;
                }
                // code ends 04/02/26
                ...
                field("Qty. to Invoice"; Rec."Qty. to Invoice")
                {
                    ...
                    begin
                        SetItemChargeFieldsStyle();
                        if Rec.FOC then begin
                            if Rec."Qty. to Invoice" <> 0 then
                                Error('Qty. to Invoice will be zero for Free supply');
                        end;
                    end;
                }
...
#pragma warning restore AA0074
    ...
    //------------------04/02/26 code related to calculate commission note amount
    local procedure RecalculateCommissionNoteAmount()
    var
        TotalAmt: Decimal;
    begin
        if (Rec."No." = '') or (Rec."Quantity" = 0) or (rec."Unit Price" = 0) then begin
            Rec."Commission Note Amount" := 0;
            Rec.Modify(false);
            exit;
        end else begin
            TotalAmt := Rec."Line Amount" - (Rec."Negotiated Price" + Rec."Freight Charge" + Rec."Insurance Charge" + Rec."CN Other Charges");
            if TotalAmt < 0 then
                Error('The Commission Note Amount can not be less than actual line amount')
            else
                Rec."Commission Note Amount" := TotalAmt;
        end;
        Rec.Modify(false);
    end;
    //-------------- end of 04/02/26 code

pageextension 50013 PostedSalesShipment extends "Posted Sales Shipment"
{
    layout
    {
        ...
        addafter(General)
        {
            group("Spares")
            {
                ...
                group(SpareGeneral1)
                {
                    ...
                    field("Spare_Executive Master2"; Rec."Executive Master2")
                    {
                        ApplicationArea = All;
                        Caption = 'Executive Master 2';
                        ToolTip = 'Specifies the value of the Authorized Person ID field.';
                    }
        ...
        addafter("&Print")
        {
            action(PrintPackageLabel)
            {
                ...
                begin
                    ...
                    PostedSalesShipment.SetRange("No.", Rec."No.");
                    if PostedSalesShipment.FindFirst() then
                        Report.RunModal(Report::"Package Label", true, false, PostedSalesShipment);
                end;
            }
        }
    }

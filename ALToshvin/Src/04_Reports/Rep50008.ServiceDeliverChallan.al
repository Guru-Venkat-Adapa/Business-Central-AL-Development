report 50008 "Service Deliver Challan"
{
    ApplicationArea = All;
    Caption = 'Service Deliver Challan';
    UsageCategory = ReportsAndAnalysis;
    RDLCLayout = 'Src\04_Reports\Layouts\DeliverChallanService.rdl';
    dataset
    {
        dataitem("Sales Shipment Header"; "Sales Shipment Header")
        {
            ...
            begin
                ...
                Clear(Remarks);
                // if "Sales Shipment Header"."Sales Order Type" = 'SERVICES' then begin
                //     SalesComments.Reset();
                ...
                // end
                // else
                //     if ("Sales Shipment Header"."Sales Order Type" in ['AMC', 'CMC', 'CONSUMBALE']) then begin

report 50045 "Custom Purchase Invoice"
{
    Caption = 'Purchase - Invoice';
    PreviewMode = PrintLayout;
    DefaultLayout = RDLC;
    RDLCLayout = 'Src\Reports\Layouts\PurchaseInvoice.rdlc';
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Purch. Inv. Line"; "Purch. Inv. Line")
                    {
                        ...
                        begin
                            ...
                            TotalAmountInclVAT += TotalSubTotal + CGSTAmt + SGSTAmt + IGSTAmt;
    ...
    begin
        GLSetup.Get();
        CompanyInfo.SetAutoCalcFields(CompanyInfo."Picture");
        CompanyInfo.Get();

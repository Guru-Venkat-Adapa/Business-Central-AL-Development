...
report 50028 ServiceTaxInvoiceWithoutLOGO
{
    Caption = 'Service Tax Invoices (Without LOGO)';
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    RDLCLayout = 'Src\Reports\Layouts\ServiceTaxInvoiceWithoutLogo.rdl';
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            begin
                ...
                //QR Code
                Clear(EncodeStr);
                if Header."QR Code".HasValue then begin

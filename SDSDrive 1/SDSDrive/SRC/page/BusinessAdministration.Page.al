page 60000 "Business Administration"
{
    PageType = RoleCenter;
    ...
    layout
    {
        area(rolecenter)
        {
            ...
            part("Trailing ITem Period"; "Trailing ITem Period")
            {
                ApplicationArea = Basic, Suite;
            }
            part("trailing sales Period Default"; "Trailing Sales Orders Chart")
            {
                ApplicationArea = Basic, Suite;
            }
            part("trailing sales Period"; "Trailing sales Period")
            {
                ApplicationArea = Basic, Suite;
            }

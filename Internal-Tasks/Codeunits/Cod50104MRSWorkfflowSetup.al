codeunit 50104 "MRS Workflow Setup"
{
    ...
    begin
        ...
        Workflow,
        BuildClaimTypeConditions(MRSHeader.SIT_Status::Open),
        WorkflowEventHandlingCust.RunWorkflowOnSendClaimforApprovalCode,
        BuildClaimTypeConditions(MRSHeader.SIT_Status::"Request Pending"),
    ...
    var
        MRSHeader: Record MRSHeader;
    begin
        MRSHeader.SetRange(SIT_Status, Status);

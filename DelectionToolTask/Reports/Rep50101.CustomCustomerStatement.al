report 50101 "Custom Customer Statement"
{
    ...
    DefaultLayout = Word;
    WordLayout = 'GuruCustomerStatement1.docx';
    dataset
    {
                    ...
                    dataitem(CustLedgEntryHdr; "Integer")
                    {
...

                        {
                            ...
                            begin
                                ...
                                if TempCustomerNo <> Customer."No." then begin
                                    CheckData := 0;
                                    checkdata := RemainingAmount;
                                end else
                                    CheckData += RemainingAmount;

report 50121 "Customer Outstanding"
{
    Caption = 'Customer Outstanding';
    ApplicationArea = All;
    UsageCategory = ReportsAndAnalysis;
    RDLCLayout = 'Layouts/SDSStatement.rdl';
    WordLayout = 'Layouts/SDSStatement.docx';
    DefaultLayout = Word;
                ...
                dataitem(CurrencyLoop; "Integer")
                {
                                ...
                                case "Entry Type" of
                                    "Entry Type"::"Initial Entry":
                                        begin
                                            ...
                                            //02042024 Start
                                            // StatusOpen := true;
                                            // CustLedgerEntry.SetRange(Open, StatusOpen);
                                            CustLedgerEntry.SetFilter("Document Type", 'Invoice|Credit Memo');
                                            ...
                                            TotalRemainingAmount := TotalRemainingAmount + CustLedgerEntry."Remaining Amount";
                                    ...
                                    "Entry Type"::Application:
                                        begin
                                            ...
                                            //02042024
                                            DetailedCustLedgEntry2.SetFilter("Document Type", 'Invoice|Credit Memo');
                    ...
                    dataitem(OverdueVisible; "Integer")
                    {
                        ...
                        dataitem(CustLedgEntry2; "Cust. Ledger Entry")
                        {
                            ...
                            // PrintOnlyIfDetail = true;
                            // RequestFilterFields = Open, "Document Type";
                            ...
                            begin
                                ...
                                //02042024 Start
                                // StatusOpen := true;
                                // CustLedgEntry.SetRange(Open, StatusOpen);

                                CustLedgEntry.SetFilter("Document Type", 'Invoice|Credit Memo');
    ...
    begin
        ...
        // 18042024 start
        if (PrintUnappliedEntries) and PrintReversedEntries then begin
            PrintUnappliedEntries := false;

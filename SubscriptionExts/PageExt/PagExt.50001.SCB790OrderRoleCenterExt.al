...
/// </summary>
pageextension 50001 "SCB 790 Order Role Center Ext." extends "Order Processor Role Center"
{
    layout
    {
    }
    ...
    actions
    {
        addlast(Creation)
        {
            ...
            {
                RunObject = page "SCB Subscription Order";
                RunPageMode = Create;
                ApplicationArea = All;
                Image = NewOrder;
        ...
        addlast(Embedding)
        {
            ...
            {
                RunObject = page "SCB Subscription List";
                RunPageMode = View;
                ApplicationArea = All;
                Image = BlanketOrder;

...
report 50105 "Inventory - Availability Plan"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            column(PeriodStartDate131; Format(PeriodStartDate[13] - 1))
            {
            }
            column(PeriodStartDate141; Format(PeriodStartDate[14] - 1))
            {
            }
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(PeriodLengthData; PeriodLength)
                    {
                        ApplicationArea = Basic, Suite;
    ...
    var
        ...
        ItemFilter: Text;
        SchedReceipt: array[14] of Decimal;
        PlanReceipt: array[14] of Decimal;
        PlanRelease: array[14] of Decimal;
        PeriodStartDate: array[15] of Date;
        ProjAvBalance: array[14] of Decimal;
        GrossReq: array[14] of Decimal;
        Print: Boolean;
        i: Integer;
    ...
    local procedure CalcNeed(Item: Record Item; LocationFilter: Text; VariantFilter: Text)
    begin
